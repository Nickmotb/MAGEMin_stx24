...
SS_ref G_SS_sb24_sp_function(SS_ref SS_ref_db, char* research_group, int EM_dataset, int len_ox, bulk_info z_b, double eps){
    ...
    char   *EM_tmp[] 		= {"sp","hc","smag","picr",};
    for (int i = 0; i < SS_ref_db.n_em; i++){
        strcpy(SS_ref_db.EM_list[i],EM_tmp[i]);
    };

    // Site mixing composition;
    SS_ref_db.C[0][0] = 0.0;    SS_ref_db.C[0][1] = 1.0;    SS_ref_db.C[0][2] = 1.0;    SS_ref_db.C[0][3] = 0.0;
    SS_ref_db.C[1][0] = 1.0;    SS_ref_db.C[1][1] = 0.0;    SS_ref_db.C[1][2] = 0.0;    SS_ref_db.C[1][3] = 1.0;
    SS_ref_db.C[2][0] = 1.0;    SS_ref_db.C[2][1] = 1.0;    SS_ref_db.C[2][2] = 0.0;    SS_ref_db.C[2][3] = 0.0;
    SS_ref_db.C[3][0] = 0.0;    SS_ref_db.C[3][1] = 0.0;    SS_ref_db.C[3][2] = 1.0;    SS_ref_db.C[3][3] = 0.0;
    SS_ref_db.C[4][0] = 0.0;    SS_ref_db.C[4][1] = 0.0;    SS_ref_db.C[4][2] = 0.0;    SS_ref_db.C[4][3] = 1.0;
    ...
    SS_ref_db.W[0] = -1311.0 ;
    SS_ref_db.W[1] = 63000.0 ;
    SS_ref_db.W[2] = 21000.0 ;
    SS_ref_db.W[3] = 55000.0 ;
    SS_ref_db.W[4] = 21000.0 ;
    SS_ref_db.W[5] = 4200.0 ;
    ...
    em_data smag            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    em_data picr            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    SS_ref_db.gbase[0]        = sp.gb;
    SS_ref_db.gbase[1]        = hc.gb;
    SS_ref_db.gbase[2]        = smag.gb;
    SS_ref_db.gbase[3]        = picr.gb;

    SS_ref_db.ElShearMod[0]        = sp.ElShearMod;
    SS_ref_db.ElShearMod[1]        = hc.ElShearMod;
    SS_ref_db.ElShearMod[2]        = smag.ElShearMod;
    SS_ref_db.ElShearMod[3]        = picr.ElShearMod;

    SS_ref_db.ElBulkMod[0]        = sp.ElBulkMod;
    SS_ref_db.ElBulkMod[1]        = hc.ElBulkMod;
    SS_ref_db.ElBulkMod[2]        = smag.ElBulkMod;
    SS_ref_db.ElBulkMod[3]        = picr.ElBulkMod;

    SS_ref_db.ElCp[0]        = sp.ElCp;
    SS_ref_db.ElCp[1]        = hc.ElCp;
    SS_ref_db.ElCp[2]        = smag.ElCp;
    SS_ref_db.ElCp[3]        = picr.ElCp;

    SS_ref_db.ElExpansivity[0]        = sp.ElExpansivity;
    SS_ref_db.ElExpansivity[1]        = hc.ElExpansivity;
    SS_ref_db.ElExpansivity[2]        = smag.ElExpansivity;
    SS_ref_db.ElExpansivity[3]        = picr.ElExpansivity;

    for (i = 0; i < len_ox; i++){
        SS_ref_db.Comp[0][i] 	= sp.C[i];
        SS_ref_db.Comp[1][i] 	= hc.C[i];
        SS_ref_db.Comp[2][i] 	= smag.C[i];
        SS_ref_db.Comp[3][i] 	= picr.C[i];
    }
...
SS_ref G_SS_sb24_opx_function(SS_ref SS_ref_db, char* research_group, int EM_dataset, int len_ox, bulk_info z_b, double eps){
    ...
    SS_ref_db.W[0] = 0.0 ;
    SS_ref_db.W[1] = 0.0 ;
    SS_ref_db.W[2] = 32210.0 ;
    SS_ref_db.W[3] = 0.0 ;
    SS_ref_db.W[4] = 32210.0 ;
    SS_ref_db.W[5] = 46640.0 ;
...
SS_ref G_SS_sb24_cpx_function(SS_ref SS_ref_db, char* research_group, int EM_dataset, int len_ox, bulk_info z_b, double eps){
    ...
    char   *EM_tmp[] 		= {"di","he","cen","cats","jd","acm",};
    for (int i = 0; i < SS_ref_db.n_em; i++){
        strcpy(SS_ref_db.EM_list[i],EM_tmp[i]);
    };

    // Site mixing composition;
    SS_ref_db.C[0][0] = 1.0;    SS_ref_db.C[0][1] = 1.0;    SS_ref_db.C[0][2] = 0.0;    SS_ref_db.C[0][3] = 1.0;    SS_ref_db.C[0][4] = 0.0;    SS_ref_db.C[0][5] = 0.0;
    SS_ref_db.C[1][0] = 0.0;    SS_ref_db.C[1][1] = 0.0;    SS_ref_db.C[1][2] = 1.0;    SS_ref_db.C[1][3] = 0.0;    SS_ref_db.C[1][4] = 0.0;    SS_ref_db.C[1][5] = 0.0;
    ...
    SS_ref_db.C[4][0] = 0.0;    SS_ref_db.C[4][1] = 1.0;    SS_ref_db.C[4][2] = 0.0;    SS_ref_db.C[4][3] = 0.0;    SS_ref_db.C[4][4] = 0.0;    SS_ref_db.C[4][5] = 1.0;
    SS_ref_db.C[5][0] = 1.0;    SS_ref_db.C[5][1] = 0.0;    SS_ref_db.C[5][2] = 1.0;    SS_ref_db.C[5][3] = 0.0;    SS_ref_db.C[5][4] = 0.0;    SS_ref_db.C[5][5] = 0.0;
    ...
    SS_ref_db.N[1][0] = 0.8816496580927726;    SS_ref_db.N[1][1] = -0.11835034190722742;    SS_ref_db.N[1][2] = -0.11835034190722742;    SS_ref_db.N[1][3] = -0.11835034190722742;    SS_ref_db.N[1][4] = -0.11835034190722742;
    SS_ref_db.N[2][0] = -0.11835034190722742;    SS_ref_db.N[2][1] = 0.8816496580927726;    SS_ref_db.N[2][2] = -0.11835034190722742;    SS_ref_db.N[2][3] = -0.11835034190722742;    SS_ref_db.N[2][4] = -0.11835034190722742;
    SS_ref_db.N[3][0] = -0.11835034190722742;    SS_ref_db.N[3][1] = -0.11835034190722742;    SS_ref_db.N[3][2] = 0.8816496580927726;    SS_ref_db.N[3][3] = -0.11835034190722742;    SS_ref_db.N[3][4] = -0.11835034190722742;
    SS_ref_db.N[4][0] = -0.11835034190722742;    SS_ref_db.N[4][1] = -0.11835034190722742;    SS_ref_db.N[4][2] = -0.11835034190722742;    SS_ref_db.N[4][3] = 0.8816496580927726;    SS_ref_db.N[4][4] = -0.11835034190722742;
    SS_ref_db.N[5][0] = -0.11835034190722742;    SS_ref_db.N[5][1] = -0.11835034190722742;    SS_ref_db.N[5][2] = -0.11835034190722742;    SS_ref_db.N[5][3] = -0.11835034190722742;    SS_ref_db.N[5][4] = 0.8816496580927726;
    ...
    SS_ref_db.W[5] = 24740.0 ;
    SS_ref_db.W[6] = 26000.0 ;
    SS_ref_db.W[7] = 24300.0 ;
    SS_ref_db.W[8] = 24300.0 ;
    SS_ref_db.W[9] = 63720.0 ;
    SS_ref_db.W[10] = 46040.0 ;
    SS_ref_db.W[11] = 46040.0 ;
    SS_ref_db.W[12] = 10000.0 ;
    SS_ref_db.W[13] = 10000.0 ;
    SS_ref_db.W[14] = 0.0 ;
    ...
    em_data acm            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    SS_ref_db.ElShearMod[3]        = cats.ElShearMod;
    SS_ref_db.ElShearMod[4]        = jd.ElShearMod;
    SS_ref_db.ElShearMod[5]        = acm.ElShearMod;
    ...
    SS_ref_db.ElBulkMod[3]        = cats.ElBulkMod;
    SS_ref_db.ElBulkMod[4]        = jd.ElBulkMod;
    SS_ref_db.ElBulkMod[5]        = acm.ElBulkMod;
    ...
    SS_ref_db.ElExpansivity[3]        = cats.ElExpansivity;
    SS_ref_db.ElExpansivity[4]        = jd.ElExpansivity;
    SS_ref_db.ElExpansivity[5]        = acm.ElExpansivity;
...
SS_ref G_SS_sb24_hpcpx_function(SS_ref SS_ref_db, char* research_group, int EM_dataset, int len_ox, bulk_info z_b, double eps){
    ...
    em_data mgc2            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    em_data fec2            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    SS_ref_db.gbase[0]        = mgc2.gb;
    SS_ref_db.gbase[1]        = fec2.gb;

    SS_ref_db.ElShearMod[0]        = mgc2.ElShearMod;
    SS_ref_db.ElShearMod[1]        = fec2.ElShearMod;

    SS_ref_db.ElBulkMod[0]        = mgc2.ElBulkMod;
    SS_ref_db.ElBulkMod[1]        = fec2.ElBulkMod;

    SS_ref_db.ElCp[0]        = mgc2.ElCp;
    SS_ref_db.ElCp[1]        = fec2.ElCp;

    SS_ref_db.ElExpansivity[0]        = mgc2.ElExpansivity;
    SS_ref_db.ElExpansivity[1]        = fec2.ElExpansivity;

    for (i = 0; i < len_ox; i++){
        SS_ref_db.Comp[0][i] 	= mgc2.C[i];
        SS_ref_db.Comp[1][i] 	= fec2.C[i];
    }
...
SS_ref G_SS_sb24_ak_function(SS_ref SS_ref_db, char* research_group, int EM_dataset, int len_ox, bulk_info z_b, double eps){
    ...
    char   *EM_tmp[] 		= {"mgak","feak","co","hem","esk",};
    for (int i = 0; i < SS_ref_db.n_em; i++){
        strcpy(SS_ref_db.EM_list[i],EM_tmp[i]);
    };
    ...
    // Site mixing composition;
    SS_ref_db.C[0][0] = 0.0;    SS_ref_db.C[0][1] = 0.0;    SS_ref_db.C[0][2] = 1.0;    SS_ref_db.C[0][3] = 0.0;    SS_ref_db.C[0][4] = 0.0;
    SS_ref_db.C[1][0] = 0.0;    SS_ref_db.C[1][1] = 1.0;    SS_ref_db.C[1][2] = 0.0;    SS_ref_db.C[1][3] = 1.0;    SS_ref_db.C[1][4] = 0.0;
    ...
    SS_ref_db.W[0] = 0.0 ;
    SS_ref_db.W[1] = 62490.0 ;
    SS_ref_db.W[2] = 65000.0 ;
    SS_ref_db.W[3] = 93180.0 ;
    SS_ref_db.W[4] = 62490.0 ;
    SS_ref_db.W[5] = 65000.0 ;
    SS_ref_db.W[6] = 93180.0 ;
    SS_ref_db.W[7] = 65000.0 ;
    SS_ref_db.W[8] = 40000.0 ;
    SS_ref_db.W[9] = 40000.0 ;
    ...
    em_data hem            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    em_data esk            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    SS_ref_db.gbase[1]        = feak.gb;
    SS_ref_db.gbase[2]        = co.gb;
    SS_ref_db.gbase[3]        = hem.gb;
    SS_ref_db.gbase[4]        = esk.gb;

    SS_ref_db.ElShearMod[0]        = mgak.ElShearMod;
    SS_ref_db.ElShearMod[1]        = feak.ElShearMod;
    SS_ref_db.ElShearMod[2]        = co.ElShearMod;
    SS_ref_db.ElShearMod[3]        = hem.ElShearMod;
    SS_ref_db.ElShearMod[4]        = esk.ElShearMod;

    SS_ref_db.ElBulkMod[0]        = mgak.ElBulkMod;
    SS_ref_db.ElBulkMod[1]        = feak.ElBulkMod;
    SS_ref_db.ElBulkMod[2]        = co.ElBulkMod;
    SS_ref_db.ElBulkMod[3]        = hem.ElBulkMod;
    SS_ref_db.ElBulkMod[4]        = esk.ElBulkMod;

    SS_ref_db.ElCp[0]        = mgak.ElCp;
    SS_ref_db.ElCp[1]        = feak.ElCp;
    SS_ref_db.ElCp[2]        = co.ElCp;
    SS_ref_db.ElCp[3]        = hem.ElCp;
    SS_ref_db.ElCp[4]        = esk.ElCp;

    SS_ref_db.ElExpansivity[0]        = mgak.ElExpansivity;
    SS_ref_db.ElExpansivity[1]        = feak.ElExpansivity;
    SS_ref_db.ElExpansivity[2]        = co.ElExpansivity;
    SS_ref_db.ElExpansivity[3]        = hem.ElExpansivity;
    SS_ref_db.ElExpansivity[4]        = esk.ElExpansivity;

    for (i = 0; i < len_ox; i++){
        SS_ref_db.Comp[0][i] 	= mgak.C[i];
        SS_ref_db.Comp[1][i] 	= feak.C[i];
        SS_ref_db.Comp[2][i] 	= co.C[i];
        SS_ref_db.Comp[3][i] 	= hem.C[i];
        SS_ref_db.Comp[4][i] 	= esk.C[i];
    }
...
SS_ref G_SS_sb24_gtmj_function(SS_ref SS_ref_db, char* research_group, int EM_dataset, int len_ox, bulk_info z_b, double eps){
    ...
    char   *EM_tmp[] 		= {"py","alm","gr","mgmj","jdmj","knor","andr",};
    for (int i = 0; i < SS_ref_db.n_em; i++){
        strcpy(SS_ref_db.EM_list[i],EM_tmp[i]);
    };
    ...
    SS_ref_db.C[2][0] = 0.0;    SS_ref_db.C[2][1] = 1.0;    SS_ref_db.C[2][2] = 0.0;    SS_ref_db.C[2][3] = 0.0;    SS_ref_db.C[2][4] = 0.0;    SS_ref_db.C[2][5] = 0.0;    SS_ref_db.C[2][6] = 0.0;
    SS_ref_db.C[3][0] = 1.0;    SS_ref_db.C[3][1] = 0.0;    SS_ref_db.C[3][2] = 0.0;    SS_ref_db.C[3][3] = 1.0;    SS_ref_db.C[3][4] = 0.0;    SS_ref_db.C[3][5] = 1.0;    SS_ref_db.C[3][6] = 0.0;
    SS_ref_db.C[4][0] = 0.0;    SS_ref_db.C[4][1] = 0.0;    SS_ref_db.C[4][2] = 0.0;    SS_ref_db.C[4][3] = 0.0;    SS_ref_db.C[4][4] = 0.6666666666666666;    SS_ref_db.C[4][5] = 0.0;    SS_ref_db.C[4][6] = 0.0;
    SS_ref_db.C[5][0] = 1.0;    SS_ref_db.C[5][1] = 1.0;    SS_ref_db.C[5][2] = 1.0;    SS_ref_db.C[5][3] = 0.0;    SS_ref_db.C[5][4] = 1.0;    SS_ref_db.C[5][5] = 0.0;    SS_ref_db.C[5][6] = 0.0;
    ...
    SS_ref_db.C[7][0] = 0.0;    SS_ref_db.C[7][1] = 0.0;    SS_ref_db.C[7][2] = 0.0;    SS_ref_db.C[7][3] = 1.0;    SS_ref_db.C[7][4] = 0.0;    SS_ref_db.C[7][5] = 0.0;    SS_ref_db.C[7][6] = 0.0;
    SS_ref_db.C[8][0] = 0.0;    SS_ref_db.C[8][1] = 0.0;    SS_ref_db.C[8][2] = 0.0;    SS_ref_db.C[8][3] = 0.0;    SS_ref_db.C[8][4] = 0.0;    SS_ref_db.C[8][5] = 1.0;    SS_ref_db.C[8][6] = 0.0;
    SS_ref_db.C[9][0] = 0.0;    SS_ref_db.C[9][1] = 0.0;    SS_ref_db.C[9][2] = 0.0;    SS_ref_db.C[9][3] = 1.0;    SS_ref_db.C[9][4] = 1.0;    SS_ref_db.C[9][5] = 0.0;    SS_ref_db.C[9][6] = 0.0;
    SS_ref_db.C[10][0] = 1.0;    SS_ref_db.C[10][1] = 1.0;    SS_ref_db.C[10][2] = 1.0;    SS_ref_db.C[10][3] = 0.0;    SS_ref_db.C[10][4] = 0.0;    SS_ref_db.C[10][5] = 0.0;    SS_ref_db.C[10][6] = 0.0;
    SS_ref_db.C[11][0] = 0.0;    SS_ref_db.C[11][1] = 0.0;    SS_ref_db.C[11][2] = 0.0;    SS_ref_db.C[11][3] = 0.0;    SS_ref_db.C[11][4] = 0.0;    SS_ref_db.C[11][5] = 0.0;    SS_ref_db.C[11][6] = 1.0;
    SS_ref_db.C[12][0] = 0.0;    SS_ref_db.C[12][1] = 0.0;    SS_ref_db.C[12][2] = 0.0;    SS_ref_db.C[12][3] = 0.0;    SS_ref_db.C[12][4] = 0.0;    SS_ref_db.C[12][5] = 1.0;    SS_ref_db.C[12][6] = 0.0;
    ...
    SS_ref_db.N[1][0] = 0.8963274121682046;    SS_ref_db.N[1][1] = -0.10367258783179546;    SS_ref_db.N[1][2] = -0.10367258783179546;    SS_ref_db.N[1][3] = -0.10367258783179546;    SS_ref_db.N[1][4] = -0.10367258783179546;    SS_ref_db.N[1][5] = -0.10367258783179546;
    SS_ref_db.N[2][0] = -0.10367258783179546;    SS_ref_db.N[2][1] = 0.8963274121682046;    SS_ref_db.N[2][2] = -0.10367258783179546;    SS_ref_db.N[2][3] = -0.10367258783179546;    SS_ref_db.N[2][4] = -0.10367258783179546;    SS_ref_db.N[2][5] = -0.10367258783179546;
    SS_ref_db.N[3][0] = -0.10367258783179546;    SS_ref_db.N[3][1] = -0.10367258783179546;    SS_ref_db.N[3][2] = 0.8963274121682046;    SS_ref_db.N[3][3] = -0.10367258783179546;    SS_ref_db.N[3][4] = -0.10367258783179546;    SS_ref_db.N[3][5] = -0.10367258783179546;
    SS_ref_db.N[4][0] = -0.10367258783179546;    SS_ref_db.N[4][1] = -0.10367258783179546;    SS_ref_db.N[4][2] = -0.10367258783179546;    SS_ref_db.N[4][3] = 0.8963274121682046;    SS_ref_db.N[4][4] = -0.10367258783179546;    SS_ref_db.N[4][5] = -0.10367258783179546;
    SS_ref_db.N[5][0] = -0.10367258783179546;    SS_ref_db.N[5][1] = -0.10367258783179546;    SS_ref_db.N[5][2] = -0.10367258783179546;    SS_ref_db.N[5][3] = -0.10367258783179546;    SS_ref_db.N[5][4] = 0.8963274121682046;    SS_ref_db.N[5][5] = -0.10367258783179546;
    ...
    SS_ref_db.W[4] = 0.0 ;
    SS_ref_db.W[5] = 53000.0 ;
    SS_ref_db.W[6] = 0.0 ;
    SS_ref_db.W[7] = 23160.0 ;
    ...
    SS_ref_db.W[14] = 0.0 ;
    SS_ref_db.W[15] = 71170.0 ;
    SS_ref_db.W[16] = 25880.0 ;
    SS_ref_db.W[17] = 64680.0 ;
    SS_ref_db.W[18] = 25880.0 ;
    SS_ref_db.W[19] = 64680.0 ;
    SS_ref_db.W[20] = 75000.0 ;
    ...
    em_data knor            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    em_data andr            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    SS_ref_db.gbase[3]        = mgmj.gb;
    SS_ref_db.gbase[4]        = jdmj.gb;
    SS_ref_db.gbase[5]        = knor.gb;
    SS_ref_db.gbase[6]        = andr.gb;
    ...
    SS_ref_db.ElShearMod[3]        = mgmj.ElShearMod;
    SS_ref_db.ElShearMod[4]        = jdmj.ElShearMod;
    SS_ref_db.ElShearMod[5]        = knor.ElShearMod;
    SS_ref_db.ElShearMod[6]        = andr.ElShearMod;
    ...
    SS_ref_db.ElBulkMod[3]        = mgmj.ElBulkMod;
    SS_ref_db.ElBulkMod[4]        = jdmj.ElBulkMod;
    SS_ref_db.ElBulkMod[5]        = knor.ElBulkMod;
    SS_ref_db.ElBulkMod[6]        = andr.ElBulkMod;
    ...
    SS_ref_db.ElCp[3]        = mgmj.ElCp;
    SS_ref_db.ElCp[4]        = jdmj.ElCp;
    SS_ref_db.ElCp[5]        = knor.ElCp;
    SS_ref_db.ElCp[6]        = andr.ElCp;
    ...
    SS_ref_db.ElExpansivity[3]        = mgmj.ElExpansivity;
    SS_ref_db.ElExpansivity[4]        = jdmj.ElExpansivity;
    SS_ref_db.ElExpansivity[5]        = knor.ElExpansivity;
    SS_ref_db.ElExpansivity[6]        = andr.ElExpansivity;
    ...
    for (i = 0; i < len_ox; i++){
        ...
        SS_ref_db.Comp[3][i] 	= mgmj.C[i];
        SS_ref_db.Comp[4][i] 	= jdmj.C[i];
        SS_ref_db.Comp[5][i] 	= knor.C[i];
        SS_ref_db.Comp[6][i] 	= andr.C[i];
    }
...
SS_ref G_SS_sb24_pv_function(SS_ref SS_ref_db, char* research_group, int EM_dataset, int len_ox, bulk_info z_b, double eps){
    ...
    char   *EM_tmp[] 		= {"mgpv","fepv","alpv","hepv","hlpv","fapv","crpv",};
    for (int i = 0; i < SS_ref_db.n_em; i++){
        strcpy(SS_ref_db.EM_list[i],EM_tmp[i]);
    };
    ...
    SS_ref_db.C[1][0] = 0.0;    SS_ref_db.C[1][1] = 1.0;    SS_ref_db.C[1][2] = 0.0;    SS_ref_db.C[1][3] = 1.0;    SS_ref_db.C[1][4] = 1.0;    SS_ref_db.C[1][5] = 1.0;    SS_ref_db.C[1][6] = 0.0;
    SS_ref_db.C[2][0] = 1.0;    SS_ref_db.C[2][1] = 0.0;    SS_ref_db.C[2][2] = 0.0;    SS_ref_db.C[2][3] = 0.0;    SS_ref_db.C[2][4] = 0.0;    SS_ref_db.C[2][5] = 0.0;    SS_ref_db.C[2][6] = 0.0;
    SS_ref_db.C[3][0] = 0.0;    SS_ref_db.C[3][1] = 0.0;    SS_ref_db.C[3][2] = 0.0;    SS_ref_db.C[3][3] = 0.0;    SS_ref_db.C[3][4] = 0.0;    SS_ref_db.C[3][5] = 0.0;    SS_ref_db.C[3][6] = 1.0;
    ...
    SS_ref_db.C[6][0] = 0.0;    SS_ref_db.C[6][1] = 0.0;    SS_ref_db.C[6][2] = 0.0;    SS_ref_db.C[6][3] = 1.0;    SS_ref_db.C[6][4] = 1.0;    SS_ref_db.C[6][5] = 0.0;    SS_ref_db.C[6][6] = 0.0;
    ...
    SS_ref_db.W[0] = -12470.0 ;
    SS_ref_db.W[1] = 31660.0 ;
    SS_ref_db.W[2] = 93860.0 ;
    SS_ref_db.W[3] = 49860.0 ;
    SS_ref_db.W[4] = 0.0 ;
    SS_ref_db.W[5] = 93180.0 ;
    SS_ref_db.W[6] = 0.0 ;
    SS_ref_db.W[7] = 93870.0 ;
    SS_ref_db.W[8] = 49860.0 ;
    SS_ref_db.W[9] = 0.0 ;
    SS_ref_db.W[10] = 93180.0 ;
    SS_ref_db.W[11] = 65000.0 ;
    SS_ref_db.W[12] = 65000.0 ;
    SS_ref_db.W[13] = 65000.0 ;
    SS_ref_db.W[14] = 40000.0 ;
    SS_ref_db.W[15] = -58750.0 ;
    SS_ref_db.W[16] = 65000.0 ;
    SS_ref_db.W[17] = 40000.0 ;
    SS_ref_db.W[18] = 65000.0 ;
    SS_ref_db.W[19] = 40000.0 ;
    SS_ref_db.W[20] = 40000.0 ;
    ...
    em_data hepv            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    em_data hlpv            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    em_data fapv            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    em_data crpv            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    SS_ref_db.gbase[1]        = fepv.gb;
    SS_ref_db.gbase[2]        = alpv.gb;
    SS_ref_db.gbase[3]        = hepv.gb;
    SS_ref_db.gbase[4]        = hlpv.gb;
    SS_ref_db.gbase[5]        = fapv.gb;
    SS_ref_db.gbase[6]        = crpv.gb;

    SS_ref_db.ElShearMod[0]        = mgpv.ElShearMod;
    SS_ref_db.ElShearMod[1]        = fepv.ElShearMod;
    SS_ref_db.ElShearMod[2]        = alpv.ElShearMod;
    SS_ref_db.ElShearMod[3]        = hepv.ElShearMod;
    SS_ref_db.ElShearMod[4]        = hlpv.ElShearMod;
    SS_ref_db.ElShearMod[5]        = fapv.ElShearMod;
    SS_ref_db.ElShearMod[6]        = crpv.ElShearMod;

    SS_ref_db.ElBulkMod[0]        = mgpv.ElBulkMod;
    SS_ref_db.ElBulkMod[1]        = fepv.ElBulkMod;
    SS_ref_db.ElBulkMod[2]        = alpv.ElBulkMod;
    SS_ref_db.ElBulkMod[3]        = hepv.ElBulkMod;
    SS_ref_db.ElBulkMod[4]        = hlpv.ElBulkMod;
    SS_ref_db.ElBulkMod[5]        = fapv.ElBulkMod;
    SS_ref_db.ElBulkMod[6]        = crpv.ElBulkMod;

    SS_ref_db.ElCp[0]        = mgpv.ElCp;
    SS_ref_db.ElCp[1]        = fepv.ElCp;
    SS_ref_db.ElCp[2]        = alpv.ElCp;
    SS_ref_db.ElCp[3]        = hepv.ElCp;
    SS_ref_db.ElCp[4]        = hlpv.ElCp;
    SS_ref_db.ElCp[5]        = fapv.ElCp;
    SS_ref_db.ElCp[6]        = crpv.ElCp;

    SS_ref_db.ElExpansivity[0]        = mgpv.ElExpansivity;
    SS_ref_db.ElExpansivity[1]        = fepv.ElExpansivity;
    SS_ref_db.ElExpansivity[2]        = alpv.ElExpansivity;
    SS_ref_db.ElExpansivity[3]        = hepv.ElExpansivity;
    SS_ref_db.ElExpansivity[4]        = hlpv.ElExpansivity;
    SS_ref_db.ElExpansivity[5]        = fapv.ElExpansivity;
    SS_ref_db.ElExpansivity[6]        = crpv.ElExpansivity;

    for (i = 0; i < len_ox; i++){
        SS_ref_db.Comp[0][i] 	= mgpv.C[i];
        SS_ref_db.Comp[1][i] 	= fepv.C[i];
        SS_ref_db.Comp[2][i] 	= alpv.C[i];
        SS_ref_db.Comp[3][i] 	= hepv.C[i];
        SS_ref_db.Comp[4][i] 	= hlpv.C[i];
        SS_ref_db.Comp[5][i] 	= fapv.C[i];
        SS_ref_db.Comp[6][i] 	= crpv.C[i];
    }
...
SS_ref G_SS_sb24_ppv_function(SS_ref SS_ref_db, char* research_group, int EM_dataset, int len_ox, bulk_info z_b, double eps){
    ...
    char   *EM_tmp[] 		= {"mppv","fppv","appv","hppv","cppv",};
    for (int i = 0; i < SS_ref_db.n_em; i++){
        strcpy(SS_ref_db.EM_list[i],EM_tmp[i]);
    };
    ...
    SS_ref_db.W[0] = -39830.0 ;
    SS_ref_db.W[1] = 31660.0 ;
    SS_ref_db.W[2] = 93870.0 ;
    SS_ref_db.W[3] = 93180.0 ;
    SS_ref_db.W[4] = 31660.0 ;
    SS_ref_db.W[5] = 93870.0 ;
    SS_ref_db.W[6] = 93180.0 ;
    SS_ref_db.W[7] = 65000.0 ;
    SS_ref_db.W[8] = 40000.0 ;
    SS_ref_db.W[9] = 40000.0 ;
    ...
    em_data hppv            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    em_data cppv            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    SS_ref_db.gbase[1]        = fppv.gb;
    SS_ref_db.gbase[2]        = appv.gb;
    SS_ref_db.gbase[3]        = hppv.gb;
    SS_ref_db.gbase[4]        = cppv.gb;

    SS_ref_db.ElShearMod[0]        = mppv.ElShearMod;
    SS_ref_db.ElShearMod[1]        = fppv.ElShearMod;
    SS_ref_db.ElShearMod[2]        = appv.ElShearMod;
    SS_ref_db.ElShearMod[3]        = hppv.ElShearMod;
    SS_ref_db.ElShearMod[4]        = cppv.ElShearMod;

    SS_ref_db.ElBulkMod[0]        = mppv.ElBulkMod;
    SS_ref_db.ElBulkMod[1]        = fppv.ElBulkMod;
    SS_ref_db.ElBulkMod[2]        = appv.ElBulkMod;
    SS_ref_db.ElBulkMod[3]        = hppv.ElBulkMod;
    SS_ref_db.ElBulkMod[4]        = cppv.ElBulkMod;

    SS_ref_db.ElCp[0]        = mppv.ElCp;
    SS_ref_db.ElCp[1]        = fppv.ElCp;
    SS_ref_db.ElCp[2]        = appv.ElCp;
    SS_ref_db.ElCp[3]        = hppv.ElCp;
    SS_ref_db.ElCp[4]        = cppv.ElCp;

    SS_ref_db.ElExpansivity[0]        = mppv.ElExpansivity;
    SS_ref_db.ElExpansivity[1]        = fppv.ElExpansivity;
    SS_ref_db.ElExpansivity[2]        = appv.ElExpansivity;
    SS_ref_db.ElExpansivity[3]        = hppv.ElExpansivity;
    SS_ref_db.ElExpansivity[4]        = cppv.ElExpansivity;

    for (i = 0; i < len_ox; i++){
        SS_ref_db.Comp[0][i] 	= mppv.C[i];
        SS_ref_db.Comp[1][i] 	= fppv.C[i];
        SS_ref_db.Comp[2][i] 	= appv.C[i];
        SS_ref_db.Comp[3][i] 	= hppv.C[i];
        SS_ref_db.Comp[4][i] 	= cppv.C[i];
    }
...
SS_ref G_SS_sb24_cf_function(SS_ref SS_ref_db, char* research_group, int EM_dataset, int len_ox, bulk_info z_b, double eps){
    ...
    char   *EM_tmp[] 		= {"mgcf","fecf","nacf","hmag","crcf",};
    for (int i = 0; i < SS_ref_db.n_em; i++){
        strcpy(SS_ref_db.EM_list[i],EM_tmp[i]);
    };

    // Site mixing composition;
    SS_ref_db.C[0][0] = 0.0;    SS_ref_db.C[0][1] = 1.0;    SS_ref_db.C[0][2] = 0.0;    SS_ref_db.C[0][3] = 1.0;    SS_ref_db.C[0][4] = 0.0;
    SS_ref_db.C[1][0] = 1.0;    SS_ref_db.C[1][1] = 0.0;    SS_ref_db.C[1][2] = 0.0;    SS_ref_db.C[1][3] = 0.0;    SS_ref_db.C[1][4] = 1.0;
    SS_ref_db.C[2][0] = 0.0;    SS_ref_db.C[2][1] = 0.0;    SS_ref_db.C[2][2] = 1.0;    SS_ref_db.C[2][3] = 0.0;    SS_ref_db.C[2][4] = 0.0;
    SS_ref_db.C[3][0] = 0.0;    SS_ref_db.C[3][1] = 0.0;    SS_ref_db.C[3][2] = 1.0;    SS_ref_db.C[3][3] = 0.0;    SS_ref_db.C[3][4] = 0.0;
    SS_ref_db.C[4][0] = 1.0;    SS_ref_db.C[4][1] = 1.0;    SS_ref_db.C[4][2] = 0.0;    SS_ref_db.C[4][3] = 0.0;    SS_ref_db.C[4][4] = 0.0;
    SS_ref_db.C[5][0] = 0.0;    SS_ref_db.C[5][1] = 0.0;    SS_ref_db.C[5][2] = 0.0;    SS_ref_db.C[5][3] = 1.0;    SS_ref_db.C[5][4] = 0.0;
    SS_ref_db.C[6][0] = 0.0;    SS_ref_db.C[6][1] = 0.0;    SS_ref_db.C[6][2] = 0.0;    SS_ref_db.C[6][3] = 0.0;    SS_ref_db.C[6][4] = 1.0;
    SS_ref_db.C[7][0] = 1.0;    SS_ref_db.C[7][1] = 1.0;    SS_ref_db.C[7][2] = 1.0;    SS_ref_db.C[7][3] = 0.0;    SS_ref_db.C[7][4] = 0.0;
    SS_ref_db.C[8][0] = 0.0;    SS_ref_db.C[8][1] = 0.0;    SS_ref_db.C[8][2] = 0.0;    SS_ref_db.C[8][3] = 1.0;    SS_ref_db.C[8][4] = 0.0;
    SS_ref_db.C[9][0] = 0.0;    SS_ref_db.C[9][1] = 0.0;    SS_ref_db.C[9][2] = 0.0;    SS_ref_db.C[9][3] = 0.0;    SS_ref_db.C[9][4] = 1.0;
    ...
    SS_ref_db.W[0] = 0.0 ;
    SS_ref_db.W[1] = 67190.0 ;
    SS_ref_db.W[2] = 0.0 ;
    SS_ref_db.W[3] = 0.0 ;
    SS_ref_db.W[4] = 67190.0 ;
    SS_ref_db.W[5] = 0.0 ;
    SS_ref_db.W[6] = 0.0 ;
    SS_ref_db.W[7] = 0.0 ;
    SS_ref_db.W[8] = 67190.0 ;
    SS_ref_db.W[9] = 0.0 ;

    SS_ref_db.v[0] = 1.0;
    SS_ref_db.v[1] = 1.0;
    SS_ref_db.v[2] = 3.97647;
    SS_ref_db.v[3] = 1.0;
    SS_ref_db.v[4] = 1.0;
    ...
    em_data hmag            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    em_data crcf            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    SS_ref_db.gbase[1]        = fecf.gb;
    SS_ref_db.gbase[2]        = nacf.gb;
    SS_ref_db.gbase[3]        = hmag.gb;
    SS_ref_db.gbase[4]        = crcf.gb;

    SS_ref_db.ElShearMod[0]        = mgcf.ElShearMod;
    SS_ref_db.ElShearMod[1]        = fecf.ElShearMod;
    SS_ref_db.ElShearMod[2]        = nacf.ElShearMod;
    SS_ref_db.ElShearMod[3]        = hmag.ElShearMod;
    SS_ref_db.ElShearMod[4]        = crcf.ElShearMod;

    SS_ref_db.ElBulkMod[0]        = mgcf.ElBulkMod;
    SS_ref_db.ElBulkMod[1]        = fecf.ElBulkMod;
    SS_ref_db.ElBulkMod[2]        = nacf.ElBulkMod;
    SS_ref_db.ElBulkMod[3]        = hmag.ElBulkMod;
    SS_ref_db.ElBulkMod[4]        = crcf.ElBulkMod;

    SS_ref_db.ElCp[0]        = mgcf.ElCp;
    SS_ref_db.ElCp[1]        = fecf.ElCp;
    SS_ref_db.ElCp[2]        = nacf.ElCp;
    SS_ref_db.ElCp[3]        = hmag.ElCp;
    SS_ref_db.ElCp[4]        = crcf.ElCp;

    SS_ref_db.ElExpansivity[0]        = mgcf.ElExpansivity;
    SS_ref_db.ElExpansivity[1]        = fecf.ElExpansivity;
    SS_ref_db.ElExpansivity[2]        = nacf.ElExpansivity;
    SS_ref_db.ElExpansivity[3]        = hmag.ElExpansivity;
    SS_ref_db.ElExpansivity[4]        = crcf.ElExpansivity;

    for (i = 0; i < len_ox; i++){
        SS_ref_db.Comp[0][i] 	= mgcf.C[i];
        SS_ref_db.Comp[1][i] 	= fecf.C[i];
        SS_ref_db.Comp[2][i] 	= nacf.C[i];
        SS_ref_db.Comp[3][i] 	= hmag.C[i];
        SS_ref_db.Comp[4][i] 	= crcf.C[i];
    }
...
SS_ref G_SS_sb24_mw_function(SS_ref SS_ref_db, char* research_group, int EM_dataset, int len_ox, bulk_info z_b, double eps){
    ...
    char   *EM_tmp[] 		= {"pe","wu","wuls","mag","anao",};
    for (int i = 0; i < SS_ref_db.n_em; i++){
        strcpy(SS_ref_db.EM_list[i],EM_tmp[i]);
    };

    // Site mixing composition;
    SS_ref_db.C[0][0] = 0.0;    SS_ref_db.C[0][1] = 1.0;    SS_ref_db.C[0][2] = 1.0;    SS_ref_db.C[0][3] = 0.5;    SS_ref_db.C[0][4] = 0.0;
    SS_ref_db.C[1][0] = 1.0;    SS_ref_db.C[1][1] = 0.0;    SS_ref_db.C[1][2] = 0.0;    SS_ref_db.C[1][3] = 0.0;    SS_ref_db.C[1][4] = 0.0;
    SS_ref_db.C[2][0] = 0.0;    SS_ref_db.C[2][1] = 0.0;    SS_ref_db.C[2][2] = 0.0;    SS_ref_db.C[2][3] = 0.0;    SS_ref_db.C[2][4] = 1.0;
    SS_ref_db.C[3][0] = 0.0;    SS_ref_db.C[3][1] = 0.0;    SS_ref_db.C[3][2] = 0.0;    SS_ref_db.C[3][3] = 0.0;    SS_ref_db.C[3][4] = 1.0;
    SS_ref_db.C[4][0] = 0.0;    SS_ref_db.C[4][1] = 1.0;    SS_ref_db.C[4][2] = 1.0;    SS_ref_db.C[4][3] = 0.5;    SS_ref_db.C[4][4] = 0.0;
    ...
    SS_ref_db.W[4] = -60220.0 ;
    SS_ref_db.W[5] = 106200.0 ;
    SS_ref_db.W[6] = 120000.0 ;
    SS_ref_db.W[7] = 106200.0 ;
    SS_ref_db.W[8] = 120000.0 ;
    SS_ref_db.W[9] = 120000.0 ;

    SS_ref_db.v[0] = 1.0;
    SS_ref_db.v[1] = 1.0;
    SS_ref_db.v[2] = 1.0;
    SS_ref_db.v[3] = 0.08293;
    SS_ref_db.v[4] = 1.0;
    ...
    em_data wuls            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    em_data mag            = get_em_data(    research_group, EM_dataset,
                                            len_ox,
                                            z_b,
                                            SS_ref_db.P,
                                            SS_ref_db.T,
    ...
    SS_ref_db.gbase[0]        = pe.gb;
    SS_ref_db.gbase[1]        = wu.gb;
    SS_ref_db.gbase[2]        = wuls.gb;
    SS_ref_db.gbase[3]        = mag.gb;
    SS_ref_db.gbase[4]        = anao.gb;

    SS_ref_db.ElShearMod[0]        = pe.ElShearMod;
    SS_ref_db.ElShearMod[1]        = wu.ElShearMod;
    SS_ref_db.ElShearMod[2]        = wuls.ElShearMod;
    SS_ref_db.ElShearMod[3]        = mag.ElShearMod;
    SS_ref_db.ElShearMod[4]        = anao.ElShearMod;

    SS_ref_db.ElBulkMod[0]        = pe.ElBulkMod;
    SS_ref_db.ElBulkMod[1]        = wu.ElBulkMod;
    SS_ref_db.ElBulkMod[2]        = wuls.ElBulkMod;
    SS_ref_db.ElBulkMod[3]        = mag.ElBulkMod;
    SS_ref_db.ElBulkMod[4]        = anao.ElBulkMod;

    SS_ref_db.ElCp[0]        = pe.ElCp;
    SS_ref_db.ElCp[1]        = wu.ElCp;
    SS_ref_db.ElCp[2]        = wuls.ElCp;
    SS_ref_db.ElCp[3]        = mag.ElCp;
    SS_ref_db.ElCp[4]        = anao.ElCp;

    SS_ref_db.ElExpansivity[0]        = pe.ElExpansivity;
    SS_ref_db.ElExpansivity[1]        = wu.ElExpansivity;
    SS_ref_db.ElExpansivity[2]        = wuls.ElExpansivity;
    SS_ref_db.ElExpansivity[3]        = mag.ElExpansivity;
    SS_ref_db.ElExpansivity[4]        = anao.ElExpansivity;

    for (i = 0; i < len_ox; i++){
        SS_ref_db.Comp[0][i] 	= pe.C[i];
        SS_ref_db.Comp[1][i] 	= wu.C[i];
        SS_ref_db.Comp[2][i] 	= wuls.C[i];
        SS_ref_db.Comp[3][i] 	= mag.C[i];
        SS_ref_db.Comp[4][i] 	= anao.C[i];
    }
...
SS_ref G_SS_sb24_nal_function(SS_ref SS_ref_db, char* research_group, int EM_dataset, int len_ox, bulk_info z_b, double eps){
    ...
    SS_ref_db.W[0] = 0.0 ;
    SS_ref_db.W[1] = -62080.0 ;
    SS_ref_db.W[2] = -62080.0 ;
    ...
    for (int FD = 0; FD < gv.n_Diff; FD++){	
        ...
        if (strcmp( name, "plg") == 0 ){
            SS_ref_db  = G_SS_sb24_plg_function(SS_ref_db, gv.research_group, EM_dataset, gv.len_ox, z_b, eps);	}
        else if (strcmp( name, "sp") == 0 ){
            SS_ref_db  = G_SS_sb24_sp_function(SS_ref_db, gv.research_group, EM_dataset, gv.len_ox, z_b, eps);	}
        else if (strcmp( name, "ol") == 0 ){
            SS_ref_db  = G_SS_sb24_ol_function(SS_ref_db, gv.research_group, EM_dataset, gv.len_ox, z_b, eps);	}
        else if (strcmp( name, "wa") == 0 ){
            SS_ref_db  = G_SS_sb24_wa_function(SS_ref_db, gv.research_group, EM_dataset, gv.len_ox, z_b, eps);	}
        else if (strcmp( name, "ri") == 0 ){
            SS_ref_db  = G_SS_sb24_ri_function(SS_ref_db, gv.research_group, EM_dataset, gv.len_ox, z_b, eps);	}
        else if (strcmp( name, "opx") == 0 ){
            SS_ref_db  = G_SS_sb24_opx_function(SS_ref_db, gv.research_group, EM_dataset, gv.len_ox, z_b, eps);	}
        else if (strcmp( name, "cpx") == 0 ){
            SS_ref_db  = G_SS_sb24_cpx_function(SS_ref_db, gv.research_group, EM_dataset, gv.len_ox, z_b, eps);	}
        else if (strcmp( name, "hpcpx") == 0 ){
            SS_ref_db  = G_SS_sb24_hpcpx_function(SS_ref_db, gv.research_group, EM_dataset, gv.len_ox, z_b, eps);	}
        else if (strcmp( name, "ak") == 0 ){
            SS_ref_db  = G_SS_sb24_ak_function(SS_ref_db, gv.research_group, EM_dataset, gv.len_ox, z_b, eps);	}
        else if (strcmp( name, "gtmj") == 0 ){
            SS_ref_db  = G_SS_sb24_gtmj_function(SS_ref_db, gv.research_group, EM_dataset, gv.len_ox, z_b, eps);	}
        else if (strcmp( name, "pv") == 0 ){
            SS_ref_db  = G_SS_sb24_pv_function(SS_ref_db, gv.research_group, EM_dataset, gv.len_ox, z_b, eps);	}
        else if (strcmp( name, "ppv") == 0 ){
            SS_ref_db  = G_SS_sb24_ppv_function(SS_ref_db, gv.research_group, EM_dataset, gv.len_ox, z_b, eps);	}
        else if (strcmp( name, "cf") == 0 ){
            SS_ref_db  = G_SS_sb24_cf_function(SS_ref_db, gv.research_group, EM_dataset, gv.len_ox, z_b, eps);	}
        else if (strcmp( name, "mw") == 0 ){
            SS_ref_db  = G_SS_sb24_mw_function(SS_ref_db, gv.research_group, EM_dataset, gv.len_ox, z_b, eps);	}
        else if (strcmp( name, "nal") == 0 ){
            SS_ref_db  = G_SS_sb24_nal_function(SS_ref_db, gv.research_group, EM_dataset, gv.len_ox, z_b, eps);	}
        else{
            printf("\nsolid solution '%s' is not in the database\n",name);	}
