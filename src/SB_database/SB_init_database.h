...
#define __SB_init_db_H_
	...
	**/
	...
	/** 
		Stixrude and Lithgow-Bertelloni 2011 dataset
	**/
	...
	/** 
		Stixrude and Lithgow-Bertelloni 2021 dataset
	**/
	typedef struct stx21_datasets {
		int 	ds_version;
		int 	n_ox;
		int 	n_pp;
		int 	n_ss;
	...
	/** 
		Stixrude and Lithgow-Bertelloni 2024 dataset
	**/
	typedef struct stx24_datasets {
		int 	ds_version;
		int 	n_ox;
		int 	n_pp;
		int 	n_ss;
