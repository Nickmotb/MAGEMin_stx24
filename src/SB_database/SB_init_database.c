...
oxide_data oxide_info_sb = {
    ...
    {66.7736,42.9947,108.653,38.7162,40.3262,61.1729,69.1514,70.3246,30.5827,40.1891,106.9795,69.5449,62.8768,9.5557,33.2556, ENTROPY},
...
global_variable get_bulk_stx24( global_variable gv) {
   ...
   if (gv.test == 0){ //KLB1
	   ...
	   gv.bulk_rock[4]  = 50.49;		/** MgO 	*/
	   gv.bulk_rock[5]  = 0.250;		/** Na2O 	*/
	   gv.bulk_rock[6]  = 0.0;		/** Cr2O3 	*/
	   gv.bulk_rock[7]  = 0.0;		/** O 	*/
